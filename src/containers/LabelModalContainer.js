...
export class LabelModalContainer extends React.Component {
  ...
  componentDidUpdate() {
    if (this.props.docs !== undefined) {
      if (this.props.repeatModal && this.state.currentDoc === null) {
        ...
        if (
          this.props.docsToLabel === undefined ||
      ...
      if (
        this.props.labelledDocs !== undefined &&
        this.state.numLabelled !== Object.keys(this.props.labelledDocs).length
      ) {
        this.setState({
  ...
  handleLabelDocClick() {
    ...
    this.props.labelledDocs[this.state.currentDoc] = {
      label,
      timestamp: new Date(),
    };
  ...
  getRandomDocToLabel() {
    const maxIndex =
      Object.keys(this.props.docs).length -
      Object.keys(this.props.labelledDocs).length;

    const randomIndex = Math.floor(Math.random() * maxIndex);
    const docToLabel = Object.keys(this.props.docs)[randomIndex];
